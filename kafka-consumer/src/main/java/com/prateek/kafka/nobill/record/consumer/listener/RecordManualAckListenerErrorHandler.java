 ...
 */
@Component("recordManualAckListenerErrorHandler")
public class RecordManualAckListenerErrorHandler implements ConsumerAwareListenerErrorHandler {
    ...
    public Object handleError(Message<?> message, ListenerExecutionFailedException exception, Consumer<?, ?> consumer) {
        ...
        recordConsumerSampleService.manualAckErrorAtOffset(offset);
        recordConsumerSampleService.manualAckError();
        return null;
    }
}
