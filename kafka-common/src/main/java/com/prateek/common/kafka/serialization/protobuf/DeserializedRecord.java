package com.prateek.common.kafka.serialization.protobuf;
 ...
 *
 * @param <T>
 * @Note We may not need this class to prevent endless loop in consumer because the {@link com.prateek.common.kafka.consumer.KafkaGlobalContainerErrorHandler} will be automatically registered into KafkaListenerContainer (view more in the code {@link com.prateek.common.kafka.consumer.KafkaListenerContainerFactoryConstructor}).
